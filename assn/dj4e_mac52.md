...
This document describes how to run Django 5.2 on your Mac and expose it to the internet using <a href="https://localhost.run" target="_blank">localhost.run</a> so that DJ4E autograders can test your work.
...
**Other platforms:** [Windows](dj4e_windows52.md) · [WSL](dj4e_wsl52.md) · [Linux](dj4e_linux52.md) · [Overview](dj4e_local52.md)
...
3. **SSH** – Used by localhost.run (no signup required). SSH is pre-installed on Mac.
