...
**Note** Starting May 2025, this course moved form Django 4.2 to Django 5.2
with significant changes to the assignments and lectures.  This is a legacy file
that is no longer used.  Please use the updated documentation at:

<a href="dj4e_install52.md">Installing Django 5.2 on PythonAnywhere</a>.


This file is no longer supported
--------------------------------

If for some strange reason in 2026, you are still doing this course with Django 4.2
feel free to use this file - but it is out of date and no longer supported.
