...
/**
 * Installation sanity checks for the DJ4E home page only.
 */

function dj4e_sanity_die($title, $body_html) {
    error_log('DJ4E sanity: '.$title);
...
if ( ! is_dir($tsugi_dir) ) {
    dj4e_sanity_die(
        ...
        '<p>This copy of Django for Everybody expects a <code>tsugi</code> folder next to
        <code>index.php</code>, but that folder was not found.</p>
        <p>From your <code>dj4e</code> directory, check out Tsugi:</p>
        <pre>cd dj4e
git clone https://github.com/tsugiproject/tsugi.git tsugi</pre>
        ...
        <p>More detail: <a href="https://github.com/csev/dj4e/blob/master/README.md"
        target="_blank" rel="noopener noreferrer">DJ4E README</a></p>'
    );
}
...
if ( count($missing) > 0 ) {
    dj4e_sanity_die(
        ...
        <p>From your <code>dj4e</code> directory, refresh the Tsugi checkout:</p>
        <pre>cd dj4e/tsugi
git pull
