...
<p>We do honor Do Not Track signals.  When DNT is indicated, we suppress the gathering of all internal analytics data and do not use any third-party (Google only) analytics on the pages the user visits.</p>
...
Our goal is to comply both with the letter and spirit of privacy laws like the Family Educational Rights and Privacy Act (FERPA) and EU General Data Protection Regulation (GDPR) regulations. We aspire to a company that far exceeds the minimum requirements of these laws.
</p><p>
