...
<a href="../../assn/dj4e_hello.md" class="btn btn-info" target="_blank" rel="noopener noreferrer" aria-label="Assignment instructions (opens in new tab)">dj4e_hello.md</a>
</a>.
...
$url = getUrl('http://dj4e.pythonanywhere.com');
