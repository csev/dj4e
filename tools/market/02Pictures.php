...
echo("<h2>MarketPlace with Pictures (2)</h2>\n");
...
<?php
$url = getUrl('https://market.dj4e.com/m2', 0, true);
if ( $url === false ) return;
...
if ( strpos($html, 'window.File') > 1 ) {
    ...
    error_out("The autograder looks for a specific code pattern—based on the sample code you were supposed to adapt for this page—to verify the file size. AI-generated code to test file size might work in your browser but still fail the autograder.");
    return;
}
