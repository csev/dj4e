<?php
/**
 * Django Girls 04 – urls
 * Verifies grade_check view and URL routing.
 * Corresponds to: Django URLs, Django views
 */

require_once __DIR__ . "/../crud/webauto.php";

line_out("Django Girls 04 – urls");
?>
<p>
Assignment:
...
if ( $check && stripos($html, $check) !== false ) {
    ...
    error_out("grade_check must return your check string. Expected to find '$check'.");
